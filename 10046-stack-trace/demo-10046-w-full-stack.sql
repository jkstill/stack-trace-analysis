...
alter session set tracefile_identifier = 'FULL-STACK-TRACE';
...
alter session set events ='wait_event["db file scattered read"]{wait:minwait=1000} 
 trace(
	''event "%", p1 %, p2 %, p3 %, wait time %\nStk=%\n'',   
	evargs(5), evargn(2), evargn(3),evargn(4), evargn(1), shortstack()
)'
;
